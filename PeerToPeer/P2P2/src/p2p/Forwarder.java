...
public class Forwarder {
  ...
  public Forwarder() {
    peerInfo = PeerManager.getInstance().getDafaultPeer();
  }

  //guardar el msg en un formato estandar de comunicación
  public String marshall(String msg) {
    return msg;
  }
